...
if (isset($id)) {
$penyewa = mysqli_query($mysqli, "SELECT * FROM penyewa_makam WHERE id_sewa='$id' AND id_user='$id_user' AND id_makam='$id_makam' AND blok='$blok' AND jumlah='$jumlah' AND jam='$jam'");
while ($s = mysqli_fetch_array($penyewa)) {
  $verifsewa = $s['verif'];
}
} else {
$penyewas = mysqli_query($mysqli, "SELECT * FROM penyewa_makam WHERE id_user='$id_user' AND id_makam='$id_makam' AND blok='$blok' AND jumlah='$jumlah' AND jam='$jam'");
while ($s = mysqli_fetch_array($penyewas)) {
  $verifsewa = $s['verif'];
  $sid_user = $s['id_user'];
  $sid_makam = $s['id_makam'];
  $sblok = $s['blok'];
  $sjumlah = $s['jumlah'];
  $sjam = $s['jam'];
  $snama = $s['nama'];
  ...
  $scatatan = $s['catatan'];
  $sgbr_smb = $s['gbr_smb'];
  $sgbr_smb_ukuran = $s['gbr_smb_ukuran'];
  $sgbr_kk_ktp = $s['gbr_kk_ktp'];
  $sgbr_kk_ktp_ukuran = $s['gbr_kk_ktp_ukuran'];
  $sgbr_sk = $s['gbr_sk'];
  $sgbr_sk_ukuran = $s['gbr_sk_ukuran'];
  $sgbr_kk_ktp_jenazah = $s['gbr_kk_ktp_jenazah'];
  $sgbr_kk_ktp_jenazah_ukuran = $s['gbr_kk_ktp_jenazah_ukuran'];
  $sgbr_sk_instansi = $s['gbr_sk_instansi'];
  $sgbr_sk_instansi_ukuran = $s['gbr_sk_instansi_ukuran'];
  $sgbr_sk_lokal = $s['gbr_sk_lokal'];
  $sgbr_sk_lokal_ukuran = $s['gbr_sk_lokal_ukuran'];
  $sgbr_sp = $s['gbr_sp'];
  $sgbr_sp_ukuran = $s['gbr_sp_ukuran'];
}
}
            ...
            <div class="row">
                    <div class="col-md-7 col-lg-5">
                              ...
                              <form action="../../../assets/data-proses/index.php" method="post" enctype="multipart/form-data">                    
                                ...
                                <input type="hidden" name="verif_bayar" value="no">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" id="catatansewa" placeholder="email@email.com" required="">
                                  </div>
                              ...
                              <form action="../../../assets/data-proses/index.php" method="post" enctype="multipart/form-data">                    
                                <h6 class="berkaspemohons">Berkas Persyaratan</h6> 
                                <h6 class="berkaspemohonssyarat" style="top: 232px;">Pemohon wajib mengupload dokumen persyaratan sesuai dengan persyaratan berlaku</h6> 
                                <h6 class="pemohons">Data Pemohon</h6>
                                <input type="hidden" name="id_user" value="<?=$_SESSION['id_user']?>">
                                <input type="hidden" name="id_makam" value="<?=$id_makam?>">
                                <input type="hidden" name="verif_bayar" value="no">
                                ...
                                <div class="form-group">
                                    <label for="formGroupExampleInput2" class="catatan">Email</label>
                                    <input type="text" name="email" class="form-control" id="catatansewa" placeholder="email@email.com" value="<?=$semail?>" required="">
                                  </div>
                              ...
                              <form action="../../../assets/data-proses/index.php" method="post" enctype="multipart/form-data">                    
                                ...
                                <div class="form-group">
                                    <label for="formGroupExampleInput2" class="catatan">Email</label>
                                    <input type="text" name="email" class="form-control" id="catatansewa" placeholder="email@email.com" value="<?=$semail?>" required="" disabled="">
                                  </div>
