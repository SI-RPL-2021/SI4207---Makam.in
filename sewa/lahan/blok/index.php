...
$SqlQuery = mysqli_query($mysqli, "SELECT * FROM makam_stok WHERE id_makam='$id_makam' AND stok>='1'");
$makam_stok = mysqli_query($mysqli, "SELECT * FROM makam_stok WHERE id_makam='$id_makam' AND stok>='1'");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container"><br><br>
        <table width="100%">
            <tr>
                <td><a href="../"><button class="btn btn-primary" id="btnback2" style="margin-top: 6%;">Back</button></a></td>
            </tr>
        </table>
        <table width="70%" style="margin-top: 1%;float: left;text-align: center;margin-left: 0;border-collapse: initial;padding: 3%;border-radius: .25rem;border: 1px solid rgba(0,0,0,.125);box-shadow: 0px 3px 3px 0px grey;font-family: 'Quicksand', sans-serif;padding-bottom: 10%;">
            <tr>
                <td><h1 class="login">Block Makam</h1></td>
            </tr>
            <tr>
            ...
            ?>
            <tr>
                <td><a href="../unit/?id_makam=<?=$makam['id_makam']?>&blok=<?=$makam['blok']?>" style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;">
                    <div class="form-check form-check-inline" style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;width: 100%;margin-top: 2%;">
                        ...
                        <label class='form-check-label' for='inlineRadio1' style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;float: left;width: 100%;margin-right: 20%; margin-top: -22px;margin-left: -10%;">Blok <?=$makam['blok']?>
                            <span class="kafling" style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;float: right;margin-right: 50%;"><?=rupiah($makam['harga'])?>,-</span>
                        </label>
                    </div>
                </a></td>
            </tr>
        ...
        <table width="30%" style="float: right;text-align: center;">
            <tr>
                <td><image src="../../../assets/block.png" style="z-index: -2;width: 205px;position: static;margin-top: 30%;"></td>
            </tr>
        </table>
    </div>
