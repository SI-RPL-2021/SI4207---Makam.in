...
$blok = $_GET['blok'];
$SqlQuery = mysqli_query($mysqli, "SELECT * FROM paket_sewa");
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container"><br><br>
        <table width="100%">
            <tr>
                <td><a href="../blok/?id_makam=<?=$id_makam?>"><button class="btn btn-primary" id="btnback2" style="margin-top: 6%;">Back</button></a></td>
            </tr>
        </table>
        <table width="70%" style="margin-top: 1%;float: left;text-align: center;margin-left: 0;border-collapse: initial;padding: 3%;border-radius: .25rem;border: 1px solid rgba(0,0,0,.125);box-shadow: 0px 3px 3px 0px grey;font-family: 'Quicksand', sans-serif;padding-bottom: 2%;">
            <tr>
                <td><h1 class="login">Unit Sewa</h1></td>
            </tr>
            <tr>
            ...
            <?php
                while ($paket = mysqli_fetch_array($SqlQuery)) {
            ?>
            <tr>
                <td><a href="../jadwal_pemakaman/?id_makam=<?=$id_makam?>&blok=<?=$blok?>&jumlah=<?=$paket['jumlah']?>" style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;">
                    <div class="form-check form-check-inline" style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;width: 100%;margin-top: 2%;">
                        ...
                        <label class='form-check-label' for='inlineRadio1' style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;float: left;width: 100%;margin-right: 20%; margin-top: -22px;margin-left: -10%;"><?=$paket['nama_paket']?>
                            <span class='kafling' style="margin: 0;top: 0;left: 0; right: 0;position: static;transform: none;float: right;margin-right: 45%;"><?=$paket['deskripsi']?></span>
                        </label>
                    </div>
                </a></td>
            </tr>
