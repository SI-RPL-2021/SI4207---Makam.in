    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="nav nav-pills">
          ...
          <div class="dropdown">
            <button class="dropbtn">Selamat Datang, <span method="post" name="user" class="users"><?php if ($verifs == "yes") {
                                                                                                    echo ($namas);
                                                                                                  } else {
                                                                                                    echo ($_SESSION['email']);
                                                                                                  } ?></span>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-lg-5">
                              ...
                              <div class="input-group-append">
                                ...
                                <div class="rowsewa2">
                                  ...
                                  <div class="input-group mb-3">
                                    <h6 class="materai3"><span class="mat">*</span> KTP dan Kartu Keluarga [KK] Jenazah (Fotokopi)</h6>
                                    <div class="input-group-append">
                                      <input type="file" name="gbr_kk_ktp_jenazah[]" multiple value="Upload" class="input-group" id="surat4" accept=".jpg,.JPG,.jpeg,.JPEG,.png,.PNG">
                                      <div class="rowsewa3">
            ...
            <div id="popup">
              <div class="window">
                <h1 class="berhasils"><?php if ($verifsewa == "wait") {
