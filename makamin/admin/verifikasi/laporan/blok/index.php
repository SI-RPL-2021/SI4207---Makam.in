...
$bu1 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b1 FROM makam_stok WHERE bulan_count=1 AND tahun_count='$tahun'");
$bu2 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b2 FROM makam_stok WHERE bulan_count=2 AND tahun_count='$tahun'");
$bu3 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b3 FROM makam_stok WHERE bulan_count=3 AND tahun_count='$tahun'");
$bu4 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b4 FROM makam_stok WHERE bulan_count=4 AND tahun_count='$tahun'");
$bu5 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b5 FROM makam_stok WHERE bulan_count=5 AND tahun_count='$tahun'");
$bu6 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b6 FROM makam_stok WHERE bulan_count=6 AND tahun_count='$tahun'");
$bu7 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b7 FROM makam_stok WHERE bulan_count=7 AND tahun_count='$tahun'");
$bu8 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b8 FROM makam_stok WHERE bulan_count=8 AND tahun_count='$tahun'");
$bu9 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b9 FROM makam_stok WHERE bulan_count=9 AND tahun_count='$tahun'");
$bu10 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b10 FROM makam_stok WHERE bulan_count=10 AND tahun_count='$tahun'");
$bu11 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b11 FROM makam_stok WHERE bulan_count=11 AND tahun_count='$tahun'");
$bu12 = mysqli_query($mysqli, "SELECT COUNT(bulan_count) AS b11 FROM makam_stok WHERE bulan_count=12 AND tahun_count='$tahun'");
  ...
  <body>
    ...
    <div class="container">
      ...
      <table border="0">
        <tr>
          ...
          <input type="hidden" name="tipe" value="blok">
    ...
    new Chart("myChart", {
      ...
      options: {
        ...
        title: {
          display: true,
          text: "<?php if(isset($tahun)){echo "Laporan Bulanan Pertambahan Blok Makam Tahun ".$tahun;}else{echo "Laporan Bulanan Pertambahan Pengguna";}?>"
        }
      }
    });
    </script>
