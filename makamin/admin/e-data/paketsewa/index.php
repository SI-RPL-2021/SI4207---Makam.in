      ...
      <center>
        <table>
          <tr>
            ...
            <td><h1 style="margin: 0;font-family: 'Quicksand', sans-serif;font-weight: bold;font-size: 16px;">Data Paket Sewa</h1></td>
          </tr>
        </table>
        <a href="form/"><button class="btn btn-primary" style="margin-top:-4%;position: static;float: right;transform: none;width: 192px;">Tambah Paket Baru</button></a>
        ...
        <div class="row" style="margin-top: 3%;width: 80%;">
            <?php
              while ($view = mysqli_fetch_array($paket_sewa)) {
            ?>
                    ...
                    <tr>
                      <td colspan="2">
                        <div class="kotak" style="overflow: hidden;text-overflow: ellipsis;">
                          <h6 class="userverifs" style="font-size: 100px;margin-left: 3%; margin-top: 2%;text-transform: uppercase;width: 95%;text-align: center;"><?=$view['jumlah']?></h6>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <div class="card-title">
                          <h6 class="dadang max-card"><?=$view['nama_paket']?></h6>
                          <h6 class="makams max-card">Jumlah : <?=$view['jumlah']?></h6>
                          <p class="datauser max-card"><?=$view['deskripsi']?></p> 
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td><center><a href="form/?id=<?=$view['id_paket']?>" style="color: white;text-decoration: none;"><button onclick="togglePopup()" style="position: static;margin-left: 15%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Edit</h6></button></a></center></td>
                      <td><a href="../../../assets/delete-paket_sewa/?id=<?=$view['id_paket']?>" style="color: white;text-decoration: none;float: left;"><button onclick="togglePopup()" style="position: static;margin-left: 5%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Hapus</h6></button></a></td>
                    </tr>
                  </table>
                </div>
            </div>
