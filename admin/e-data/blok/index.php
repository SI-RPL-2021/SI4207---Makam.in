      ...
      <center>
        <table>
          <tr>
            ...
            <td><h1 style="margin: 0;font-family: 'Quicksand', sans-serif;font-weight: bold;font-size: 16px;">Data Blok & Harga Makam</h1></td>
          </tr>
        </table>
        <a href="form/"><button class="btn btn-primary" style="margin-top:-4%;position: static;float: right;transform: none;width: 180px;">Tambah</button></a>
        ...
        <div class="row" style="margin-top: 3%;width: 80%;">
            <?php
              while ($view = mysqli_fetch_array($makam_stok)) {
            ?>
                    ...
                    <tr>
                      <td colspan="2">
                        <div class="card-title">
                          ...
                          <p class="datauser max-card">Stok : <?=$view['stok']?><br>Harga : <?=$view['harga']?></p> 
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td><center><a href="form/?id=<?=$view['id_stok']?>" style="color: white;text-decoration: none;"><button onclick="togglePopup()" style="position: static;margin-left: 15%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Edit</h6></button></a></center></td>
                      <td><a href="../../../assets/delete-blok/?id=<?=$view['id_stok']?>" style="color: white;text-decoration: none;float: left;"><button onclick="togglePopup()" style="position: static;margin-left: 5%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Hapus</h6></button></a></td>
                    </tr>
                  </table>
                </div>
            </div>
