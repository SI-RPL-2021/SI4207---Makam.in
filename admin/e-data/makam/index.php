      ...
      <center>
        <table>
          <tr>
            ...
            <td><h1 style="margin: 0;font-family: 'Quicksand', sans-serif;font-weight: bold;font-size: 16px;">Data Makam</h1></td>
          </tr>
        </table>
        <a href="form/"><button class="btn btn-primary" style="margin-top:-4%;position: static;float: right;transform: none;width: 202px;">Tambah Makam Baru</button></a>
        ...
        <div class="row" style="margin-top: 3%;width: 80%;">
            <?php
              while ($view = mysqli_fetch_array($makam)) {
                ...
                <div class="profile-content">                
                  <table border="0" width="100%">                    
                    <tr>
                      <td colspan="2">
                        <center>
                        <div class="kotak" style="height: 200px;overflow: hidden;margin-left: 0;background: none;">
                          <img src="../../../source/makam/<?=$gbr[0]?>" class="card-img-top" style="height: 100%; width: auto; margin: auto;">
                        </div>
                        </center>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <div class="card-title">
                          ...
                          <h6 class="makams max-card">[<?=$view['kode_pos']?>]</h6>
                          <p class="datauser max-card"><?=$view['kecamatan']?>, <?=$view['kota']?> <br> Alamat: <?=$view['alamat']?></p> 
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td><center><a href="form/?id=<?=$view['id_makam']?>" style="color: white;text-decoration: none;"><button onclick="togglePopup()" style="position: static;margin-left: 15%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Edit</h6></button></a></center></td>
                      <td><a href="../../../assets/delete-makam/?id=<?=$view['id_makam']?>" style="color: white;text-decoration: none;float: left;"><button onclick="togglePopup()" style="position: static;margin-left: 5%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Hapus</h6></button></a></td>
                    </tr>
                  </table>
                </div>
            </div>
