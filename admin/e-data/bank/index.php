      ...
      <center>
        <table>
          <tr>
            ...
            <td><h1 style="margin: 0;font-family: 'Quicksand', sans-serif;font-weight: bold;font-size: 16px;">Data Bank</h1></td>
          </tr>
        </table>
        <a href="form/"><button class="btn btn-primary" style="margin-top:-4%;position: static;float: right;transform: none;width: 190px;">Tambah Bank Baru</button></a>
        ...
        <div class="row" style="margin-top: 3%;width: 80%;">
            <?php
              while ($view = mysqli_fetch_array($bank)) {
            ?>
                    ...
                    <tr>
                      <td colspan="2">
                        <div class="kotak" style="overflow: hidden;text-overflow: ellipsis;">
                          <h6 class="userverifs" style="font-size: 40px;margin-left: 3%; margin-top: 2%;text-transform: uppercase;width: 95%;text-align: center;"><?=$view['merek']?></h6>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <div class="card-title">
                          <h6 class="dadang max-card"><?=$view['merek']?></h6>
                          <h6 class="makams max-card">Nomor : <?=$view['nomor']?></h6>
                          <p class="datauser max-card">A/n : <?=$view['pemilik']?></p> 
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td><center><a href="form/?id=<?=$view['id_bank']?>" style="color: white;text-decoration: none;"><button onclick="togglePopup()" style="position: static;margin-left: 15%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Edit</h6></button></a></center></td>
                      <td><a href="../../../assets/delete-bank/?id=<?=$view['id_bank']?>" style="color: white;text-decoration: none;float: left;"><button onclick="togglePopup()" style="position: static;margin-left: 5%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Hapus</h6></button></a></td>
                    </tr>
                  </table>
                </div>
            </div>
