...
<html lang="en">
  ...
  <body>
    ...
    <div class="container"><br><br>
        <table width="70%" style="margin-top: 6%;float: left;text-align: center;margin-left: 0;border-collapse: initial;padding: 3%;border-radius: .25rem;border: 1px solid rgba(0,0,0,.125);box-shadow: 0px 3px 3px 0px grey;font-family: 'Quicksand', sans-serif;padding-bottom: 2%;">
            <tr>
        ...
        <table width="30%" style="float: right;text-align: center;">
            <tr>
                <td><image src="../../../assets/unit.png" style="z-index: -2;width: 205px;position: static;margin-top: 60%;"></td>
            </tr>
        </table>
    </div>
