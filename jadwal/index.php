...
$jadwal_pemakaman = mysqli_query($mysqli, "SELECT * FROM jadwal_pemakaman");
?>
<!doctype html>
<html lang="en">
  <head>
      ...
      <center>
        <table>
          <tr>
            ...
            <td><h1 style="margin: 0;font-family: 'Quicksand', sans-serif;font-weight: bold;font-size: 16px;">Data Jadwal Pemakaman</h1></td>
          </tr>
        </table>
        <a href="form/"><button class="btn btn-primary" style="margin-top:-4%;position: static;float: right;transform: none;width: 208px;">Tambah Jadwal Baru</button></a>
        ...
        <div class="row" style="margin-top: 3%;width: 80%;">
            <?php
              while ($view = mysqli_fetch_array($jadwal_pemakaman)) {
            ?>
            ...
            <div class="profile-card" id="cardverif" style="height: auto;width: 405px;margin: auto;padding: initial;">
                <div class="profile-content">                
                  <table border="0" width="100%">                    
                    <tr>
                      <td colspan="2">
                        <div class="kotak" style="overflow: hidden;text-overflow: ellipsis;">
                          <?php
                          ...
                          ?>
                          <h6 class="userverifs" style="font-size: 25px; margin-left: 3%; margin-top: 2%;text-transform: uppercase;width: 95%;text-align: center;"><?=$m['nama']?></h6>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <div class="card-title">
                          <h6 class="dadang max-card"><?=$m['nama']?></h6>
                          <?php
                          }
                          ?>
                          <h6 class="makams max-card">Blok : <?=$view['blok']?></h6>
                          <p class="datauser max-card">Jam : <?=$view['jam']?></p> 
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <!-- <td><center><a href="form/?id=<?=$view['id_jadwal']?>" style="color: white;text-decoration: none;"><button onclick="togglePopup()" style="position: static;margin-left: 15%;top: 0;left: 0;transform: none;"><h6 class="verifusr">Edit</h6></button></a></center></td> -->
                      <td colspan="2"><center><a href="../../../assets/delete-jadwal/?id=<?=$view['id_jadwal']?>" style="color: white;text-decoration: none;"><button onclick="togglePopup()" style="position: static;margin-left: 5%;top: 0;left: 0;transform: none;width: 300px;"><h6 class="verifusr">Hapus</h6></button></a></center></td>
                    </tr>
                  </table>
                </div>
            </div>
